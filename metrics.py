...
def probs_to_hard_predictions(probabilities, threshold):
    """
    Convert pobabilities to hard predictions

    :param threshold: threshold for the classes
    :param probabilities: [batch_size, num_classes] tensor, predicted probabilities of the model
    :return:
    """
    hard_preds = (probabilities >= threshold).astype(np.uint32)
    return hard_preds